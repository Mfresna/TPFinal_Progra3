...
public class RolRepositoryTest {
    ...
    @Test
    void testBuscarRol() {
        Optional<Rol> rol = rolRepository.findByRol(RolUsuario.ROL_USUARIO);
        rol.ifPresent(System.out::println);
    }

    @Test
    void testExisteRol() {
        System.out.println(rolRepository.existsByRol(RolUsuario.ROL_USUARIO));
        System.out.println(rolRepository.existsByRol(RolUsuario.ROL_ADMINISTRADOR));
    }
